...
export const routes: Routes = [
    ...
    {path: 'products-category/:categoryId', loadComponent: () => import('./features/products/product-category/products-category.component').then(m => m.ProductsCategoryComponent)},
    {path: 'products-category/:categoryId/product/:productId', loadComponent: () => import('./features/products/product-details/product-details.component').then(m => m.ProductDetailsComponent)},
