...
export const routes: Routes = [
    ...
    {path: ':categoryName/:productId/details', loadComponent: () => import('./features/products/product-details/product-details.component').then(m => m.ProductDetailsComponent)},
    {path: ':categoryName', loadComponent: () => import('./features/products/product-category/products-category.component').then(m => m.ProductsCategoryComponent)},
